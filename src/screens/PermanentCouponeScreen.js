...
export default function PermanentCouponeScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.responsiveWrapper, { maxWidth: containerMaxWidth }]}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Permanent Shopping Coupons</Text>
        </View>

        {/* Body Content */}
        <View style={styles.bodyContent}>
          <View style={[styles.messageContainer, { width: CONTAINER_WIDTH }]}>
            <Text style={styles.emptyText}>No Coupons Availble!</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
